...
import methodsecuritynew.bookingapp.model.dto.PaymentRestDto;
...
public class RestPaymentVnPay {
    ...
    public ResponseEntity<?> createPaymentVnPay(@RequestBody UpsertBookingRequest bookingRequest) throws UnsupportedEncodingException {
        ...
        if (booking !=null){
            System.out.println("In ra rồi nè");
        ...
        vnp_Params.put("vnp_OrderInfo","Thanh toán đơn đặt phòng :"+ (booking.getId()));
